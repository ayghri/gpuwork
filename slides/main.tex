...
\begin{frame}
	...
	Consecutive 4-byte words map to consecutive banks: (example with 8 banks in SMEM)
	\vspace{0.5em}
	\begin{center}
		\begin{tikzpicture}[
...
__syncthreads();
	...
	\begin{itemize}
		...
		\item Compare performance with your Exercise 2 solution, look for \texttt{ld.global}
	\end{itemize}
\end{frame}
